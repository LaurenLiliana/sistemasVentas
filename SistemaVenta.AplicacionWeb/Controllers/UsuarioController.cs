...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        [HttpPost]
        public async Task<ActionResult> Crear([FromForm] IFormFile foto, [FromForm] string modelo) {
        ...
        [HttpPut]
        public async Task<ActionResult> Editar([FromForm] IFormFile foto, [FromForm] string modelo)
        {
            GenericResponse<VMUsuario> gResponse = new GenericResponse<VMUsuario>();
