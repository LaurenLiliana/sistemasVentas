                  ...
                  <div className="card-body">
                    ...
                    <div className="input-group input-group-sm mb-3">
                      ...
                      <input
                        ...
                        aria-label="Small"
                        aria-describedby="inputGroupSubTotal"
                        id="txtSubTotal"
                        disabled=""
                      />
                    </div>
                    <div className="input-group input-group-sm mb-3">
                      <div className="input-group-prepend">
                        <span className="input-group-text" id="inputGroupIGV">
                          ISV(15%)
                        </span>
                      </div>
                      <input
                        ...
                        className="form-control text-right"
                        aria-label="Small"
                        aria-describedby="inputGroupIGV"
                        id="txtIGV"
                        disabled=""
                      />
                    </div>
                    <div className="input-group input-group-sm mb-3">
                      ...
                      <input
                        ...
                        className="form-control text-right"
                        aria-label="Small"
                        aria-describedby="inputGroupTotal"
                        id="txtTotal"
                        disabled=""
                      />
                    </div>
