...
namespace SistemaVenta.DAL.DBContext
{
    public partial class DBVENTAContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C694FF8E3");
            ...
            {
                entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F4AC26837");
            ...
            {
                entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483A6490652");
            ...
            {
                entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1079C72687A");
            ...
            {
                entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EA0EEC324");
            ...
            {
                entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13290691639");
            ...
            {
                entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F766BA0E84D");
            ...
            {
                entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8FFCEDFA5");
            ...
            {
                entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE3048771B");
            ...
            {
                entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6D7DA9119");
            ...
            {
                entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614783CF1B1");
